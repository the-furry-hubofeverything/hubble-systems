...
in {
  ...
  # === Pi cluster ===
  inherit
    (import ./picluster {inherit hostId-common inputs outputs sharedModules;})
    picluster-common
  ...
  # === Laptop cluster ===
  inherit
    (import ./lcluster {inherit hostId-common inputs outputs sharedModules;})
    lcluster-common
  ...
  # === Personal computers ===
  inherit
    (import ./pc {inherit hostId-common inputs outputs sharedModules;})
    pc-common
    Gulo-Laptop
    ;
  ...
  # === Remote servers ===
  inherit
    (import ./remote {inherit hostId-common inputs outputs sharedModules;})
    remote-common
    alex-oracle-remote
    alan-google-remote
    ;
