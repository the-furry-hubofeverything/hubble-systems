...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    systemd.tmpfiles.rules = [
      ...
      "d ${cfg.dataDir}/storage 0770 ${cfg.user} ${cfg.group} - -"
      "d ${cfg.dataDir}/bootstrap 0770 ${cfg.user} ${cfg.group} - -"
      "d ${cfg.dataDir}/bootstrap/cache 0770 ${cfg.user} ${cfg.group} - -"
      "d ${cfg.dataDir}/userfiles 0770 ${cfg.user} ${cfg.group} - -"
      "d ${cfg.dataDir}/publicfiles 0770 ${cfg.user} ${cfg.group} - -"
    ];
